...
class Book(models.Model):
    title = models.CharField(max_length = 600, default = r'Yet another book')
    author = models.CharField(max_length = 600, default = r'By yet another author')
...
class Wager(models.Model):
    ...
    new_duration = models.IntegerField(null=True)
    new_bet = models.IntegerField(null=True)
    sender_new_bet = models.IntegerField(null=True)
    sender_new_duration = models.IntegerField(null=True)
    received_new_bet = models.IntegerField(null=True)
    received_new_duration = models.IntegerField(null=True)
